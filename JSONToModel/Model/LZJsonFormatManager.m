...
@end
@implementation LZJsonFormatManager
 ...
 *  @return
 */
+ (NSString *)formatObjcWithKey:(NSString *)key value:(NSObject *)value classInfo:(LZClassInfo *)classInfo{
    ...
    if ([value isKindOfClass:[NSString class]]) {
        ...
        if ([firstObj isKindOfClass:[NSDictionary class]]) {
            LZClassInfo *childInfo = classInfo.propertyArrayDic[key];
        ...
        qualifierStr = @"strong";
        LZClassInfo *childInfo = classInfo.propertyClassDic[key];
 ...
 *  @return
 */
+ (NSString *)formatSwiftWithKey:(NSString *)key value:(NSObject *)value classInfo:(LZClassInfo *)classInfo{
...
+ (NSString *)parseClassImpContentWithClassInfo:(LZClassInfo *)classInfo{
    ...
    if ([ESJsonFormatSetting defaultSetting].outputToFiles) {
        ...
        for (NSString *key in classInfo.propertyArrayDic) {
            LZClassInfo *childClassInfo = classInfo.propertyArrayDic[key];
 ...
 *  @return
 */
+ (NSString *)parseClassHeaderContentForOjbcWithClassInfo:(LZClassInfo *)classInfo{
 ...
 *  @return
 */
+ (NSString *)parseClassContentForSwiftWithClassInfo:(LZClassInfo *)classInfo{
 ...
 *  @return
 */
+ (NSString *)dealHeaderStrWithClassInfo:(LZClassInfo *)classInfo type:(NSString *)type{
    //模板文字
